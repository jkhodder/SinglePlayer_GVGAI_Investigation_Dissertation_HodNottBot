...
public class SingleMCTSPlayer {
    ...
    public ArrayList<Vector2d> unvisitedPositions;
    ...
    public SingleMCTSPlayer(Random randomGenerator, Agent agent) {
    	unvisitedPositions = new ArrayList<>();
...
//            double delta = rollOut(tempState);
        	...
        	if(!unvisitedPositions.contains(tempState.getAvatarPosition()) && !tempState.isGameOver()) {
        	unvisitedPositions.add(tempState.getAvatarPosition());
        	}
    ...
    public ArrayList<Vector2d> getUnvisitedPositions() {
