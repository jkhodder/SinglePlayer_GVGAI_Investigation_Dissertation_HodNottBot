    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int gameIdx = 0; gameIdx <= 81; gameIdx++) {
            ...
            for (int levelIdx = 0; levelIdx < 5; levelIdx++) {
                ...
                HodNottBot.FeatureExtractionAgent.gameName = games[gameIdx];
                HodNottBot.FeatureExtractionAgent.gameLevel = levelIdx;

                seed = new Random().nextInt();

                ArcadeMachine.runOneGame(game, level, false, "HodNottBot" + ".FeatureExtractionAgent", null, seed, 0);
